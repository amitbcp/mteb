...
# def llama_bm25_loader(**kwargs):
#     model_name = kwargs.get("model_name", "llama4bm25")
#     requires_package(llama_bm25_loader, "bm25s", model_name, "pip install mteb[bm25s]")
# return Llama4BM25Wrapper(**kwargs)
