...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, required=True, help="Base path to the dataset directory.")
    parser.add_argument("--task_type", type=str, nargs='+',
                        default=["Any2AnyRetrieval", "Compositionality","DocumentUnderstanding", "VisionCentric"],
